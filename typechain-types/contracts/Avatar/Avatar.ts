...
export interface AvatarInterface extends utils.Interface {
  functions: {
    ...
    "getMaximumTokens()": FunctionFragment;
    ...
    "setMaximumTokens(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getMaximumTokens",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setMaximumTokens",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
...
export interface Avatar extends BaseContract {
  ...
  functions: {
    ...
    getMaximumTokens(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    initialize(
      ...
      _newMaximumTokens: PromiseOrValue<BigNumberish>,
  ...
  populateTransaction: {
    ...
    getMaximumTokens(overrides?: CallOverrides): Promise<PopulatedTransaction>;
